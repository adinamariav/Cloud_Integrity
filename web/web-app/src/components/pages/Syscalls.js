                    ...
                    <div className="row card-body" style = {{ backgroundColor: `lightblue`}}>
                        ...
                        <div className="col center" style =  {{ display: 'flex', 
                            ...
                            <div className="row mx-auto">
                                <SelectVM />
                                <button type="button" onClick={this.start} class="btn row btn-danger shadow" style= {{ width: `5rem`, marginLeft: `7rem`, marginTop: `5rem`}}>Run</button>
                            </div>
                        </div>
                
                        <div className="col">
                            <div className="card shadow mt-4" style = {{ backgroundColor: `lightblue` }}>
                                <div className="row card-body">
                                    <div className="scrollable overflow-auto p-3 mb-3 mb-md-0 mr-md-3" style= {{ height: `35rem` }}>
                                        <p class = 'card-text'>
