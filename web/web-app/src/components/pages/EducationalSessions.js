...
class EducationalSessions extends Component {
    render () {
        return(
                ...
                <nav aria-label="..." style = {{ marginTop:`-1rem`}}>
                            <ul class="pagination pagination-lg">
                                <li class="page-item active" aria-current="page">
                                    <span class="page-link" style= {{ backgroundColor:`#D3E0EA`, color:`black`}}>Previous sessions</span>
                                </li>
...
export default EducationalSessions;