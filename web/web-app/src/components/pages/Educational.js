        ...
        return(
            <div className="container">
                <div className="card mt-4">
                    <div className="row card-body" style = {{ backgroundColor: `gainsboro`}}>
                        ...
                        <div className="col center" style =  {{ display: 'flex', 
                            ...
                            <div className="row mx-auto">
                                <SelectVM />
                                <button type="button" onClick={() => this.context.start()} class="btn row btn-danger shadow" style= {{marginTop: `1rem`}}>Start analysis</button>
                            </div>
                        </div>
                
                        <div className="col">
                            <div className="card shadow mt-4" style = {{ backgroundColor: `silver` }}>
                                <div className="row card-body">
                                    <div className="scrollable overflow-auto p-3 mb-3 mb-md-0 mr-md-3" style= {{ height: `35rem`, backgroundColor: `silver` }}>
                                        <p class = 'card-text'>
